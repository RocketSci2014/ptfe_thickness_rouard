...
from rouard_optimization import get_transfer_func_params, get_transfer_func, simulate_reflection_signal, \
    optimize, tlbo_optimize
...
def estimate_layer_thickness_rouard():
    ...
    for sample_name in sample_names:
        ...
        start = time.time()
        # d, offset = optimize(bounds, ref, signal, trans_func_params)
